                ...
                <v-card class="mx-auto" width="400">
                    ...
                    <v-expand-transition>
                        <div v-show="reserveList.open">
                            ...
                            <v-card-actions v-if="reserveList.reserveState == '예약대기'">
                                <v-spacer></v-spacer>
                                <v-btn color="blue" variant="text"
                                    @click="confirmReserve(reserveList.id, '예약확정')">예약수락</v-btn>
                                <v-btn color="red" variant="text"
                                    @click="confirmReserve(reserveList.id, '예약거절')">예약거절</v-btn>
                            </v-card-actions>
...
export default defineComponent({
    ...
    methods: {
        ...
        getReserveList() {
            this.$axios.post("/api/reserve/list/manager", {
